            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4.5 mt-5">
                {projectsData.map((project, i) => (
                    <a
                        ...
                        target="_blank"
                    >
                        <div className="group relative h-48 rounded-xl overflow-hidden border border-white/6 bg-cover bg-center shadow-[0_6px_26px_rgba(2,2,10,0.6)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_32px_80px_rgba(123,75,255,0.12)] hover:border-white/12"
                            style={{
